...
# Ce script envoie les CSV générés vers un bucket MinIO,
# avec vérifications poussées (connexion, existence des fichiers locaux, upload, présence du bucket).
...
try:
    s3_client = boto3.client(
        ...
        region_name="us-east-1",  # Peu importe sur MinIO
    )
...
# ----------------------------------------------------------------------
# Upload de chaque fichier avec vérification
# ----------------------------------------------------------------------
